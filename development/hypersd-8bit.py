...
#%%
# # `.to` is not supported for `8-bit` bitsandbytes models. Please use the model as it is, since the model has already been set to the correct devices and casted to the correct `dtype`
...
#%% save locally
pipe.save_pretrained("/workspace/models/fused_loras_8bit")
